...
SCAN_ACTIONS={0x23:'hops',0x26:'leaves',0x24:'rejected',0x13:'arrange',0x14:'arrange',0x0d:'larger',0x4e:'larger',0x0c:'smaller',0x4a:'smaller'}
...
def install(root):
    ...
    actions={'hops':root.toggle_hops,'leaves':root.toggle_leaves,'rejected':root.toggle_rejected_visibility,'arrange':root.auto_arrange,'larger':lambda:root.change_font_size(1),'smaller':lambda:root.change_font_size(-1)}
    def dispatch(event):
